...
with open('wintering_to_breeding_routes.json', 'w') as f:
    json.dump(wintering_to_breeding_routes, f, indent=4)

print(f'Готово! Найдено {sum(len(v) for v in wintering_to_breeding_routes.values())} маршрутов wintering_to_breeding')
print(f'Сохранено в wintering_to_breeding_routes.json')